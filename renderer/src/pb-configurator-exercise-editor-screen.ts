...
class PbConfiguratorExerciseEditorScreenElement extends HTMLElement {
  ...
  #onTextInput = (field: string, value: string): void => {
    ...
    if (error && fieldElement) { const message = document.createElement("span"); message.className = "configurator-field-error"; message.textContent = error; fieldElement.append(message); }
