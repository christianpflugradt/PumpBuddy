        ...
        exercises: [
          {
            ...
            completed_sets: [],
            suggested_set: { repetition_value: 10, load_value: 25 },
          },
        ],
      },
    };
        ...
        exercises: [
          {
            ...
            set_tracking_mode: "UNILATERAL",
            skipped_at: null,
            completed_sets: [{ set_index: 1, set_side: "LEFT", load_value: 20, repetition_value: 8 }],
            suggested_set: { set_index: 1, set_side: "RIGHT", load_value: 20, repetition_value: 8 },
          },
        ],
      },
    };
