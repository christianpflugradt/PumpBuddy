...
Expected substring: "Barbell Squat"
...
Call log:
  ...
  - waiting for getByRole('region', { name: 'Configurator exercises screen' })
    - locator resolved to <section aria-label="Configurator exercises screen" class="screen-panel configurator-exercises-screen">…</section>
    - unexpected value "ExercisesManage the canonical movements and their variants.+ New ExerciseLoading exercises..."
    23 × locator resolved to <section aria-label="Configurator exercises screen" class="screen-panel configurator-exercises-screen">…</section>
